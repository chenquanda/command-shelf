...
$syncConflictRegressionPath = Join-Path $repositoryRoot "scripts\同步冲突界面回归.mjs"
...
try {
    ...
    Invoke-CheckedCommand -Label "同步冲突界面回归" -FilePath "node" -Arguments @($syncConflictRegressionPath)
