...
- 使用系统 Git 执行显式快进拉取和普通推送，不自动合并、强推或后台同步。
...
安装、升级、界面操作、同步期间窗口拖动和卸载数据保留仍需在实际安装环境中手工验收。

## 维护约束

项目保持轻量、单机和本地优先。除非有明确需求，不加入自动同步、冲突合并、命令执行、搜索、应用内 GitHub 登录、Token 管理、多人协作或其他 AI 提供方。
