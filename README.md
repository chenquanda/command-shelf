...
`2568BE7FEA9E57687502F54DD30268821AB9E34F93D262504760C15F4526EF75`
...
项目保持轻量、单机和本地优先。除非有明确需求，不加入后台同步、冲突自动解决、强制推送、命令执行、搜索、应用内 GitHub 登录、Token 管理、多人协作或其他 AI 提供方。
